PRIVACY POLICY MODEL FOR MOBILE APPLICATIONS This privacy policy governs your use of the software application [Dr Ahmed Sultan] (“Application”) for mobile devices that was created by [TabibSoft Company]. The Application is [A medical app for Dr Ahmed that allow users to contact the doctor and reserve before going to the clinic]
