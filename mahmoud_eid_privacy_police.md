PRIVACY POLICY MODEL FOR MOBILE APPLICATIONS This privacy policy governs your use of the software application [Bio Mahmoud eid] (“Application”) for mobile devices that was created by [TabibSoft Company]. The Application is [A teaching app for Mr: Mahmoud that allow users to contact the teacher, solve exams, see videos, read pdfs and coose the subjects to enroll in it]
