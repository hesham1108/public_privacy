PRIVACY POLICY MODEL FOR MOBILE APPLICATIONS This privacy policy governs your use of the software application [Seha Afdal Clinic] (“Application”) for mobile devices that was created by [TabibSoft Company]. The Application is [A medical app for Seha Afdal Clinic that allow users to contact the doctors and reserve before going to the clinic]
